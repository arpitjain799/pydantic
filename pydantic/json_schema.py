...
HandlerOverride = Callable[[_json_schema_shared.CoreSchemaOrField], JsonSchemaValue]


class GenerateJsonSchemaHandler(_json_schema_shared.GetJsonSchemaHandler):
    ...
    def __call__(self, __core_schema: _json_schema_shared.CoreSchemaOrField) -> JsonSchemaValue:
    ...
    def resolve_ref_schema(self, __maybe_ref_json_schema: JsonSchemaValue) -> JsonSchemaValue:
        ...
        if json_schema is None:
            raise LookupError(f'Could not find a ref for {ref}.')
        return json_schema
